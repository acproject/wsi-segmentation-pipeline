...
parser.add_argument('--eval_model_pth',
                    default='data/models/model_resnet18_194.pt')
...
parser.add_argument('--raw_train_pth', default='data/bach/wsi',
                    help='wsi svs and xml files')
parser.add_argument('--raw_val_pth',
                    default='data/bach/wsi')
parser.add_argument('--wsi_mask_pth',
                    default='data/test/wsi_mask')
...
parser.add_argument('--tile_w', default=512, type=int,
                    help='patch size width')
parser.add_argument('--tile_h', default=512, type=int,
                    help='patch size height')
parser.add_argument('--tile_stride_w', default=128, type=int,
